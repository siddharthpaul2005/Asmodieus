...
async def stream_transcribe(audio_chunks: AsyncIterator[bytes]) -> AsyncIterator[dict]:
    # yields {"text": str, "is_partial": bool, "language_code": str, "latency_ms": float, "request_id": str}
    ...

async def transcribe(audio_bytes: bytes, format: str = "wav") -> dict:
    # returns {"text": str, "is_partial": bool, "language_code": str, "latency_ms": float, "request_id": str}
    ...